    ...
    <form method="POST" action="/jobs/{{$job->id}}" enctype="multipart/form-data">
      ...
      <div class="mb-6">
        ...
        <input type="text" class="border border-gray-200 rounded p-2 w-full" name="duration"
          placeholder="Example: Remote, Boston MA, etc" value="{{$job->duration}}" />
      ...
      <div class="mb-6">
        <button class="bg-blue-600 text-white rounded py-2 px-4 hover:bg-blue-500 transition duration-200">
          Update Gig
        </button>
